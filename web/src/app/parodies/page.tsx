...
import { useGetParodiesQuery } from '@/services/showcase-api';
import {
...
export default function Page() {
  ...
  const { data: parodies, isLoading, isError } = useGetParodiesQuery();

  return (
    <>
      <Navbar active="Parodies" />

      <section className="text-center pt-20 px-4">
        <Heading title="Parodies:" />
